...
all_T = [[np.load('sum_terms parts{} row{} column{} n{} l{} d{} {}'.format(parts, row, col, N, L, d, IC_one)) for row in range(parts+1)] for col in range(parts+1)]
all_T = np.block(all_T)
