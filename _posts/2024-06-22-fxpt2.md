...
via a *fixed point* method, i.e. a sequnce $$\xi(k), k \in \mathbb{Z}_{\geq 1}$$ that converges to the solution. See [Link to a page]({% link URSA23/_posts/2024-06-12-fxpt.md  %}).
